...
import { ProtectionAltarComponent } from "./blocks/protection_altar.js";
...
system.beforeEvents.startup.subscribe(({ itemComponentRegistry, blockComponentRegistry }) => {
	...
	blockComponentRegistry.registerCustomComponent("to:protection_altar", ProtectionAltarComponent);
});
